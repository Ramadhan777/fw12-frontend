...
const PaymentBody = () => {
  ...
  const pay = () => {
    ...
    if (!form.fullName || !form.email || !form.phoneNumber) {
      setAlertError("Please fill your personal info");
      setTimeout(() => {
        setAlertError("");
      }, 5000);
      setLoading(false);
      ...
      <div className="flex flex-col xl:flex-row px-10 md:px-14 lg:px-28 py-10 gap-5">
        <div className="flex flex-col basis-8/12">
          ...
          <div>
            ...
            {alertSuccess ? <div className="alert alert-success shadow-lg mt-5">
                <div>
                  <svg xmlns="http://www.w3.org/2000/svg" className="stroke-current flex-shrink-0 h-6 w-6" fill="none" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M10 14l2-2m0 0l2-2m-2 2l-2-2m2 2l2 2m7-2a9 9 0 11-18 0 9 9 0 0118 0z" />
                  </svg>
            ...
            <div className="flex flex-col min-[530px]:flex-row pt-8 gap-3">
